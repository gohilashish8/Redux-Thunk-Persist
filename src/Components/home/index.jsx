    ...
    <>
      <section className="relative  bg-blueGray-50">
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-[75vh]">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=htmlFormat&amp;fit=crop&amp;w=1267&amp;q=80')",
            }}
          >
            <span
              id="blackOverlay"
          ...
          <div className="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden h-70-px translate">
            <svg
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-blueGray-500">
                      ...
                      inhtmlFormation. Remember that by this time, the user is
                      curious.
                    </p>
                  </div>
                </div>
      ...
      <div className="py-16 white">
        <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          ...
          <div className="grid gap-8 md:grid-rows-2 lg:grid-cols-2">
            <div className="row-span-2 p-6 border border-gray-100 rounded-xl shadow-md bg-gray-50 text-center sm:p-8">
            ...
            <div className="p-6 border border-gray-100 shadow-md rounded-xl bg-gray-50 sm:flex sm:space-x-8 sm:p-8">
              <img
                className="w-20 h-20 mx-auto rounded-full"
            ...
            <div className="p-6 border border-gray-100 rounded-xl shadow-md bg-gray-50 sm:flex sm:space-x-8 sm:p-8">
              <img
                className="w-20 h-20 mx-auto rounded-full"
      ...
      <section className="text-gray-600 body-font relative">
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-1/2 mt-10 md:mt-0 relative z-10 shadow-md">
      ...
      <footer className="bg-gradient-to-r from-gray-100 via-[#bdffff] to-gray-100">
            ...
            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                  <div className=" cursor-pointer hover:opacity-75">About</div>
              ...
              <div>
                ...
                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                  ...
                  <div className=" cursor-pointer hover:opacity-75">FAQs</div>
                  <div className=" cursor-pointer hover:opacity-75">
                    Live Chat
                  </div>
                </nav>
